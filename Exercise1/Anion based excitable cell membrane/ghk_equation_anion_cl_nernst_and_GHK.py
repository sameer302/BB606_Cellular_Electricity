...
vm = 58*np.log10((1000 + 690*5)/(30 + 690*cl_out)) - 58*np.log10(1.28) 
'''
...
Using GHK: Vm = 58 * log10( (4450) / (30 + 690*1000) ), neglecting 30 here = 58 * log10(4450/690000) ~ 58 * log10(6.44/1000) ~ 58 * log10(1.28 * 5 / 1000) = 58 * (log10(5/1000)) + 58 * log10(1.28)
...
plt.plot(cl_out, vm, label = "GHK")
plt.plot(cl_out, ecl, label = "Nernst")
...
plt.title("Vm vs [Cl]")
plt.legend()
plt.savefig("GHK_anion_cl_no_deviation_nernst_and_GHK.png")
plt.show()
